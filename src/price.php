...
$title = 'Стоимость обучения игре на музыкальном инструменте | Нотономика';
...
$url = 'https://notonomika.ru/price.php';
